...
import styles from './ShowDetailCast.module.scss'

const ShowDetailCast = ({id}) => {
  ...
  const API_URL = `${movieDatabase.baseUrl}/3/tv/${id}/credits?api_key=${movieDatabase.apiKey}&language=en-US`;
